...
public class ProjectManagementApplication {
    ...
    CommandLineRunner runner(){
        return args -> {
            ...
            Project pro1 = new Project("Large Production Deploy", "NOT_STARTED", "This requires all hands on deck for"
            ...
            Project pro3 = new Project("Office Reconstruction", "IN_PROGRESS", "The office building in Monroe has "
                    + "been damaged due to hurricane in the region. This needs to be reconstructed");
            Project pro4 = new Project("Improve Intranet Security", "IN_PROGRESS", "With the recent data hack, the office"
